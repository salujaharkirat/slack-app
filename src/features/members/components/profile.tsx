...
export const Profile = ({memberId, onClose}: ProfileProps) => {
  ...
  const {data: currentMember, isLoading: isLoadingCurrentMemberId } = useCurrentMember({ workspaceId });
  ...
  if (isLoadingMember || isLoadingCurrentMemberId) {
    return (
      ...
      <div className="h-full flex flex-col">
        ...
        <div className="flex flex-col p-4 items-center justify-center">
          <Avatar className="max-w-[256px] max-h-[256px] size-full">
            ...
            <AvatarFallback className="rounded-sm bg-sky-500 aspect-square text-6xl text-white">
              {avatarFallback}
            </AvatarFallback>
          </Avatar>
        </div>
                  ...
                  <DropdownMenu>
                    ...
                    <DropdownMenuContent className="w-full">
                      <DropdownMenuRadioGroup
                        ...
                        aria-disabled={isUpdatingMember}
                      >
