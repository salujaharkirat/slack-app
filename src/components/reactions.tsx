      ...
      {data.map((reaction) => (
        ...
        >
          <button
            ...
            className={cn(
            "h-6 px-2 rounded-full bg-slate-200/70 border text-slate-800 flex items-center gap-x-1",
            reaction.memberIds.includes(currentMemberId) && "bg-blue-100/70 border-blue text-blue-500"
          )}>
            {reaction.value}
            <span className={cn(
